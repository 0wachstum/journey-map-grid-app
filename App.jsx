...
export default function App() {
  ...
  // Prune empty rows/columns ALWAYS (your rule)
  ...
  // Use ONLY activeStages/activeStakeholders to render the grid
      ...
      <div className="grid-wrap">
        ...
        <div className="grid" style={gridStyle}>
          {effectiveStages.map(stage => {
            ...
            // stage is guaranteed to have at least one cell by pruning; extra guard not required

            return (
              <div key={stage} className="row" style={{ display:'contents' }}>
                {effectiveStakeholders.map(sh => {
                  const row = rowMap[sh]
                  // Keep empty placeholders for alignment when some cells missing
